...
def get_club_members():
    # Google Cache ya Proxy ke zariye data khinchna
    # Isse tumhara personal IP ban hone se koi farq nahi padega
    ...
    try:
        # Vercel ka server requests bhejega, tumhara phone nahi
...
def main():
    ...
    svg = f'''<svg width="260" height="230" viewBox="0 0 260 230" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="50%" y="130" text-anchor="middle" font-family="Georgia" font-size="12" fill="#ffdab9">'''
    
    if not members:
        svg += 'Updating Live Feed...'
    else:
        # SVG ko thoda reset karte hain taaki usernames sahi dikhen
        svg = f'''<svg width="260" height="230" viewBox="0 0 260 230" xmlns="http://www.w3.org/2000/svg">
            <rect width="256" height="226" x="2" y="2" rx="12" fill="#3d0000" stroke="#ffdab9" stroke-width="3"/>
            <rect width="260" height="45" rx="0" fill="#ffdab9"/>
